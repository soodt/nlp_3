...
class CustomFeature(FeatureExtractor):
    ...
    def transform_list(self, text_set):
        # Add your code here!
        transformed_text_set = []
        for text in text_set:
            transformed_text = self.transform(text)
            transformed_text_set.append(transformed_text)
        uni = UnigramFeature()
        uni.fit(transformed_text_set)
        train = uni.transform_list(transformed_text_set)
        return  train
        #raise Exception("Must be implemented")
...
#                     filtered.append(word)
#             filtered_words = ' '.join(filtered)
#         transformed_text_set.append(filtered_words)
#         return transformed_text_set
#         #raise Exception("Must be implemented")
#     def transform(self, text):
#         # Add your code here!
